...
//enviroment sounds	
	...
	//sound scapes
	PRECACHE_SOUND( "weapons/mp5/mp5_firesil_dist.wav");
	PRECACHE_SOUND( "weapons/mp5/mp5_fire-1_dist.wav");
	PRECACHE_SOUND( "weapons/spas12/spas12-fire_dist.wav");
	PRECACHE_SOUND( "weapons/sniper/sniper_fire-1_dist.wav");
	PRECACHE_SOUND( "weapons/ak-47/ak47_fire-1_dist.wav");
	PRECACHE_SOUND( "weapons/m4a1/m4a1_fire-1_dist.wav");
	PRECACHE_SOUND( "weapons/glock18/glock18_fire-1_dist.wav");
	PRECACHE_SOUND( "weapons/1911/1911_fire-1_dist.wav");
	PRECACHE_SOUND( "weapons/deagle/deagle_fire-1_dist.wav");
	PRECACHE_SOUND( "weapons/m249/m249_fire-1_dist.wav");
	PRECACHE_SOUND( "weapons/p90/p90_fire-1_dist.wav");
	PRECACHE_SOUND( "weapons/usas/usas_fire-1_dist.wav");
...
void CBaseHuman :: AlertSound( void )
{
	...
	pPlayer->ConditionsPresent = true;//SYS: dynamic music
}
...
void CBaseHuman :: HandleAnimEvent( MonsterEvent_t *pEvent )
{
	...
	{
		CBaseEntity *pEntidadItem = UTIL_FindEntityByClassname(NULL, "weapon_9mmAR");
...
/*	case HUMAN_AE_BURST1:
	...
	case HUMAN_AE_BURST1:
	{
		switch ( pev->weapons )
		{
			case	HUMAN_WEAPON_MP5:
				if( m_fStealthed )
				Fire( BULLET_MONSTER_MP5, 1, VECTOR_CONE_10DEGREES, m_iBrassShell, TE_BOUNCE_SHELL, "weapons/mp5/mp5_firesil");
				else
				Fire( BULLET_MONSTER_MP5, 1, VECTOR_CONE_15DEGREES, m_iBrassShell, TE_BOUNCE_SHELL, "weapons/mp5/mp5_fire-1");
				break;
			case	HUMAN_WEAPON_SHOTGUN:	Fire( BULLET_PLAYER_BUCKSHOT, 10, VECTOR_CONE_20DEGREES, m_iShotgunShell, TE_BOUNCE_SHOTSHELL, "weapons/spas12/spas12-fire");break;
			...
			case	HUMAN_WEAPON_AWP:
					...
					{
						Fire( BULLET_PLAYER_M82, 1, VECTOR_CONE_PERFECT, m_iBrassShell, TE_BOUNCE_SHELL, "weapons/sniper/sniper_fire-1"); break;
					}
				break;
			...
			case	HUMAN_WEAPON_ASSAULT:
				if (bTerrorist)
				{
					Fire( BULLET_PLAYER_FAMAS, 1, VECTOR_CONE_15DEGREES, m_iBrassShell, TE_BOUNCE_SHELL, "weapons/ak-47/ak47_fire-1");break;
				}
				else
				Fire( BULLET_PLAYER_FAMAS, 1, VECTOR_CONE_1DEGREES, m_iBrassShell, TE_BOUNCE_SHELL, "weapons/m4a1/m4a1_fire-1");break;

			case	HUMAN_WEAPON_PISTOL:
				if (bTerrorist)
				{
					Fire( BULLET_PLAYER_9MM, 1, VECTOR_CONE_3DEGREES, m_iBrassShell, TE_BOUNCE_SHELL, "weapons/glock18/glock18_fire-1");break;
				}
				else
				Fire( BULLET_PLAYER_9MM, 1, VECTOR_CONE_1DEGREES, m_iBrassShell, TE_BOUNCE_SHELL, "weapons/1911/1911_fire-1");break;

			case	HUMAN_WEAPON_DESERT:	Fire( BULLET_PLAYER_DEAGLE, 1, VECTOR_CONE_2DEGREES, m_iBrassShell, TE_BOUNCE_SHELL, "weapons/deagle/deagle_fire-1");break;
		
			case	HUMAN_WEAPON_M249:		Fire( BULLET_PLAYER_M249, 1, VECTOR_CONE_20DEGREES, m_iBrassShell, TE_BOUNCE_SHELL, "weapons/m249/m249_fire-1");break;
		
			case	HUMAN_WEAPON_UZI:		Fire( BULLET_MONSTER_MP5, 1, VECTOR_CONE_15DEGREES, m_iBrassShell, TE_BOUNCE_SHELL, "weapons/p90/p90_fire-1");break;
			case	HUMAN_WEAPON_USAS:		Fire( BULLET_MONSTER_MP5, 8, VECTOR_CONE_20DEGREES, m_iShotgunShell, TE_BOUNCE_SHOTSHELL, "weapons/usas/usas_fire-1");break;
		}
		break;
	...
	case HUMAN_AE_BURST3:
	{
		switch ( pev->weapons )
		{
			case	HUMAN_WEAPON_MP5:		Fire( BULLET_MONSTER_MP5, 1, VECTOR_CONE_20DEGREES, m_iBrassShell, TE_BOUNCE_SHELL, "weapons/mp5/mp5_fire-1");break;			
			case	HUMAN_WEAPON_ASSAULT:
				if (bTerrorist)
				{
					Fire( BULLET_PLAYER_FAMAS, 1, VECTOR_CONE_15DEGREES, m_iBrassShell, TE_BOUNCE_SHELL, "weapons/ak-47/ak47_fire-1");break;
				...
				Fire( BULLET_PLAYER_FAMAS, 1, VECTOR_CONE_10DEGREES, m_iBrassShell, TE_BOUNCE_SHELL, "weapons/m4a1/m4a1_fire-1");break;
		
			case	HUMAN_WEAPON_M249:		Fire( BULLET_PLAYER_M249, 1, VECTOR_CONE_20DEGREES, m_iBrassShell, TE_BOUNCE_SHELL, "weapons/m249/m249_fire-1");break;
				
			case	HUMAN_WEAPON_UZI:		Fire( BULLET_MONSTER_MP5, 1, VECTOR_CONE_20DEGREES, m_iBrassShell, TE_BOUNCE_SHELL, "weapons/p90/p90_fire-1");break;
			case	HUMAN_WEAPON_USAS:		Fire( BULLET_MONSTER_MP5, 8, VECTOR_CONE_20DEGREES, m_iShotgunShell, TE_BOUNCE_SHOTSHELL, "weapons/usas/usas_fire-1");break;
		}
		break;
	}
	...
	case HUMAN_AE_DROP_GUN:
	{
		if(!m_bSurrender)
		{
			if ( pev->weapons != HUMAN_WEAPON_NONE )
			{
				...
				switch ( pev->weapons )
				{
					case	HUMAN_WEAPON_MP5:		pItem = DropItem( "weapon_mp5", vecGunPos, vecGunAngles ); break;
					case	HUMAN_WEAPON_SHOTGUN:	pItem = DropItem( "weapon_shotgun", vecGunPos, vecGunAngles ); break;
					case	HUMAN_WEAPON_LAW:		pItem = DropItem( "weapon_rpg", vecGunPos, vecGunAngles ); break;
					case	HUMAN_WEAPON_AWP:		pItem = DropItem( "weapon_sniper", vecGunPos, vecGunAngles ); break;
					case	HUMAN_WEAPON_ASSAULT:	
						{
							if (bTerrorist)
							{
								pItem = DropItem( "weapon_ak47", vecGunPos, vecGunAngles ); break;
							}
							else
							pItem = DropItem( "weapon_m4a1", vecGunPos, vecGunAngles ); break;
						}
					case	HUMAN_WEAPON_PISTOL:	
						{
							if (bTerrorist)
							{
								pItem = DropItem( "weapon_glock18", vecGunPos, vecGunAngles ); break;
							}
							else
							pItem = DropItem( "weapon_9mmhandgun", vecGunPos, vecGunAngles ); break;
						}
					case	HUMAN_WEAPON_DESERT:	pItem = DropItem( "weapon_deagle", vecGunPos, vecGunAngles ); break;
					case	HUMAN_WEAPON_M249:		pItem = DropItem( "weapon_M249", vecGunPos, vecGunAngles ); break;
					case	HUMAN_WEAPON_UZI:		pItem = DropItem( "weapon_uzi", vecGunPos, vecGunAngles ); break;
					case	HUMAN_WEAPON_USAS:		pItem = DropItem( "weapon_usas", vecGunPos, vecGunAngles ); break;
				}
...
/*
	...
	while ((pEntidadLODcheck1 = UTIL_FindEntityByClassname(pEntidadLODcheck1, "player")) != NULL) 
	{	
		if ( (pev->frags == HUMAN_WEAPON_SHOTGUN) ||  (pev->frags == HUMAN_WEAPON_USAS) )
		break;
		...
		if ( flDist > 2048)
		{
			...
			vecAccuracy = VECTOR_CONE_PERFECT;
		}

		if ( flDist <= 1024)
		vecAccuracy = VECTOR_CONE_10DEGREES;
			
		if ( flDist <= 512)
		vecAccuracy = VECTOR_CONE_BAD;
		
		if ( flDist <= 128)
		vecAccuracy = VECTOR_CONE_TOOBAD;
	}*/
...
//	if( pev->weapons != HUMAN_WEAPON_AWP )
	...
	// Sound
//	if ( strcmp( szsndfile, "" ) != 0 )
//	{
		if(bPlayerisFar)
			//CHAN_STATIC and CHAN_WEAPON are so busy! lets use an empty channel
	EMIT_SOUND_DYN( ENT(0), CHAN_VOICE, szsndfile, RANDOM_FLOAT(0.3,0.6), ATTN_NONE, 0, PITCH_NORM + RANDOM_LONG(-10,10) );
		...
		//PERFORMANCE: moved at the first burst (we don't want add a new sound on each shoot)
	//	CSoundEnt::InsertSound ( bits_SOUND_COMBAT, Classify(), pev->origin, 384, 0.3 );
//	}
...
#define BULLET_SPEED	500//2000
	
	Vector v, a;
	GET_ATTACHMENT( ENT(pev), 1, vecShootOrigin, a );

/*
	switch ( pev->weapons )
	{
	case HUMAN_WEAPON_AWP:
		CBullet::Shoot( pev, vecShootOrigin, vecShootDir * BULLET_SPEED );
	break;
	}*/
	...
	if (pPlayer->m_fSlowMotionOn)
	{
		...
		{
			/*
			CBullet::Shoot( pev, vecShootOrigin, ( vecShootDir + Vector( RANDOM_LONG(-3,3),RANDOM_LONG(-3,3),RANDOM_LONG(-3,3) ) )  * BULLET_SPEED );
			CBullet::Shoot( pev, vecShootOrigin, ( vecShootDir + Vector( RANDOM_LONG(-3,3),RANDOM_LONG(-3,3),RANDOM_LONG(-3,3) ) )  * BULLET_SPEED );
			CBullet::Shoot( pev, vecShootOrigin, ( vecShootDir + Vector( RANDOM_LONG(-3,3),RANDOM_LONG(-3,3),RANDOM_LONG(-3,3) ) )  * BULLET_SPEED );
			CBullet::Shoot( pev, vecShootOrigin, ( vecShootDir + Vector( RANDOM_LONG(-3,3),RANDOM_LONG(-3,3),RANDOM_LONG(-3,3) ) )  * BULLET_SPEED );
			CBullet::Shoot( pev, vecShootOrigin, ( vecShootDir + Vector( RANDOM_LONG(-3,3),RANDOM_LONG(-3,3),RANDOM_LONG(-3,3) ) )  * BULLET_SPEED );
			CBullet::Shoot( pev, vecShootOrigin, ( vecShootDir + Vector( RANDOM_LONG(-3,3),RANDOM_LONG(-3,3),RANDOM_LONG(-3,3) ) )  * BULLET_SPEED );
	*/
			CBaseEntity *pBullet01, *pBullet02, *pBullet03, *pBullet04, *pBullet05, *pBullet06, *pBullet07, *pBullet08; 
				
			pBullet01 = CBaseEntity::Create( "bullet", vecShootOrigin, UTIL_VecToAngles( vecShootDir ), edict() );
			pBullet02 = CBaseEntity::Create( "bullet", vecShootOrigin, UTIL_VecToAngles( vecShootDir ), edict() );
			pBullet03 = CBaseEntity::Create( "bullet", vecShootOrigin, UTIL_VecToAngles( vecShootDir ), edict() );
			pBullet04 = CBaseEntity::Create( "bullet", vecShootOrigin, UTIL_VecToAngles( vecShootDir ), edict() );
			pBullet05 = CBaseEntity::Create( "bullet", vecShootOrigin, UTIL_VecToAngles( vecShootDir ), edict() );
			pBullet06 = CBaseEntity::Create( "bullet", vecShootOrigin, UTIL_VecToAngles( vecShootDir ), edict() );
			pBullet07 = CBaseEntity::Create( "bullet", vecShootOrigin, UTIL_VecToAngles( vecShootDir ), edict() );
			pBullet08 = CBaseEntity::Create( "bullet", vecShootOrigin, UTIL_VecToAngles( vecShootDir ), edict() );
		
			
			if (pBullet01)
				pBullet01->pev->velocity = pev->velocity + (gpGlobals->v_forward * BULLET_SPEED + gpGlobals->v_right * RANDOM_FLOAT(50,-50) + gpGlobals->v_up * RANDOM_FLOAT(50,-50));
			if (pBullet02)
				pBullet02->pev->velocity = pev->velocity + (gpGlobals->v_forward * BULLET_SPEED + gpGlobals->v_right * RANDOM_FLOAT(50,-50) + gpGlobals->v_up * RANDOM_FLOAT(50,-50));
			if (pBullet03)
				pBullet03->pev->velocity = pev->velocity + (gpGlobals->v_forward * BULLET_SPEED + gpGlobals->v_right * RANDOM_FLOAT(50,-50) + gpGlobals->v_up * RANDOM_FLOAT(50,-50));
			if (pBullet04)
				pBullet04->pev->velocity = pev->velocity + (gpGlobals->v_forward * BULLET_SPEED + gpGlobals->v_right * RANDOM_FLOAT(50,-50) + gpGlobals->v_up * RANDOM_FLOAT(50,-50));
			if (pBullet05)
				pBullet05->pev->velocity = pev->velocity + (gpGlobals->v_forward * BULLET_SPEED + gpGlobals->v_right * RANDOM_FLOAT(50,-50) + gpGlobals->v_up * RANDOM_FLOAT(50,-50));
			if (pBullet06)
				pBullet06->pev->velocity = pev->velocity + (gpGlobals->v_forward * BULLET_SPEED + gpGlobals->v_right * RANDOM_FLOAT(50,-50) + gpGlobals->v_up * RANDOM_FLOAT(50,-50));
			if (pBullet07)
				pBullet07->pev->velocity = pev->velocity + (gpGlobals->v_forward * BULLET_SPEED + gpGlobals->v_right * RANDOM_FLOAT(50,-50) + gpGlobals->v_up * RANDOM_FLOAT(50,-50));
			if (pBullet08)
				pBullet08->pev->velocity = pev->velocity + (gpGlobals->v_forward * BULLET_SPEED + gpGlobals->v_right * RANDOM_FLOAT(50,-50) + gpGlobals->v_up * RANDOM_FLOAT(50,-50));

			UTIL_MakeVectors ( pBullet01->pev->angles );
			UTIL_MakeVectors ( pBullet02->pev->angles );
			UTIL_MakeVectors ( pBullet03->pev->angles );
			UTIL_MakeVectors ( pBullet04->pev->angles );
			UTIL_MakeVectors ( pBullet05->pev->angles );
			UTIL_MakeVectors ( pBullet06->pev->angles );
			UTIL_MakeVectors ( pBullet07->pev->angles );
			UTIL_MakeVectors ( pBullet08->pev->angles );
		}
		else
		{
			CBullet::Shoot( pev, vecShootOrigin, vecShootDir * BULLET_SPEED );
...
//	pev->effects |= EF_MUZZLEFLASH;
	...
	if (pRocket)
		...
		pRocket->pev->velocity = pev->velocity + gpGlobals->v_forward * 25;
		else
...
/*
	if ( ptr->iHitgroup == HITGROUP_HEAD && !m_fCrouching )
	{
		Vector vecLookerOrigin = pev->origin + pev->view_ofs;//look through the caller's 'eyes'
...
*/
	...
	//works, but sometimes it crashes for some reason....
	//nice, but happens on combat and it's a bad one for the terrorists
	//if MONSTERSTATE_IDLE
	/*
	if( pPlayer && pPlayer->IsPlayer() )//only players can strip weapons, huh :I
	if (ptr->iHitgroup == 5 )//hit on hand
	{
		if (!m_bDropped)//we have something to drop
		{
			if ( (pev->weapons == HUMAN_WEAPON_PISTOL) || (pev->weapons == HUMAN_WEAPON_DESERT) )//pistols
			{

			}
			else
			{
				//TODO: strip if we use a shotgun
				


			//	if ( (!m_fGunDrawn) && (!m_bSurrender) && (!m_bKamikaze) )//if weapon hasn't been deployed and we aren't surrendered and not kamikazed
			//	if ( SafeToChangeSchedule() )
				ChangeSchedule( GetScheduleOfType( SCHED_HUMAN_DRAW_WEAPON ) );

				if ( pev->weapons != HUMAN_WEAPON_NONE )
				{
					if (pev->spawnflags & SF_MONSTER_NO_WPN_DROP) return;
					...
					if ( pItem )
					{
						pItem->pev->velocity = Vector (RANDOM_FLOAT(-150,150), RANDOM_FLOAT(-150,150), RANDOM_FLOAT(-50,150));
						pItem->pev->avelocity = Vector ( RANDOM_FLOAT( -150, 150 ), RANDOM_FLOAT( -150, 150 ), RANDOM_FLOAT( -150, 150 ) );
					}
		...
		/*	else
			{
				...
				/*
				switch (RANDOM_LONG(0,1)) //ejecuta los siguientes sonidos al azar
				{
...
/*
	...
	if ( (flDamage >  20) || (CVAR_GET_FLOAT("slowmo" ) != 0))//deagle or something
...
int CBaseHuman :: TakeDamage( entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage, int bitsDamageType)
{
	...
	if ( pevInflictor && IsAlive() && ( m_IdealMonsterState == MONSTERSTATE_DEAD ) &&  ( FBitSet( bitsDamageType, DMG_BLAST ) )/* || flDamage > 300 )*/ )
	{
...
//	STOP_SOUND( edict(), CHAN_VOICE, "npc_voices/English/voiceA/yell_macho_2_VoiceA.wav" );

	SentenceStop();

//	CineCleanup();//if the player kills me when I am jumping, die right where I am
pev->frame = 0;
	...
	case TASK_RANGE_ATTACK1:
		{
			...
			/*	if (m_hEnemy != NULL && (m_hEnemy->IsPlayer()))
				{
				//	pev->framerate = 0.5;//WHAT THE FUUCK?
				}*/
...
/*
	...
	//	pev->effects |= EF_MUZZLEFLASH;
		...
		pev->renderfx = 21; // entity light

		::RadiusDamage( pev->origin, pev, pev, RANDOM_LONG( 0, 10 ), 64, CLASS_NONE, DMG_BURN );//damae is random to avoid choreography
	}*/
...
/*	if ( pev->deadflag == DEAD_DYING )
	{
		...
		{
			Fire( BULLET_MONSTER_MP5, 1, VECTOR_CONE_20DEGREES, m_iBrassShell, TE_BOUNCE_SHELL, "weapons/mp5/mp5_fire-1.wav");
		}
	}
*/
//	if (pev->frags == HUMAN_WEAPON_MP5)
...
//	if ( (pev->sequence == 16) || (pev->sequence == 25) )
	...
	//ALERT ( at_console, "m_iFrustration %i - m_iBreakPoint %i \n",m_iFrustration, m_iBreakPoint );	
	
	if ( CVAR_GET_FLOAT("slowmo" ) != 0 )
	pev->framerate = 0.5;//0.25
	else
	{
	//	if( m_Activity == ACT_DIE_HEADSHOT_VIOLENT && bSlow )
	//	pev->framerate = 0.1;
	//	else 
		pev->framerate = 1.00;
	...
	m_fHandGrenades = 0;
/*
	if ( CVAR_GET_FLOAT( "ai_create_hotspot" ) == 1 )
	{
		if ( m_MonsterState != MONSTERSTATE_COMBAT )
		{
			if (m_hEnemy == NULL)
			{
				if ( m_fNextMarkerTime < gpGlobals->time )
				{
					CBaseHuman::CreateMarker();

					m_fNextMarkerTime = gpGlobals->time + 10;//5
				}
			}
		}
	}*/
...
/*
	CBaseEntity *pObject = UTIL_FindEntityByClassname( NULL, "func_breakable" );

	if ( pObject )
	{
		if (pObject->pev->takedamage == DAMAGE_YES)
		{
			if (pPlayer->b_PlayerIsNearOf == 3)//3 is a brekeable object
			{
				ALERT(at_console, "PLAYER IS NEAR A BREKEABLE! BREKEABLE IS AT: at %.0f, %.0f, %.0f\n", pObject->pev->origin.x,pObject->pev->origin.y,pObject->pev->origin.z );
				
				CBaseEntity *pCrab;
				Vector vecSpot;// shard origin
				vecSpot = pObject->pev->origin + Vector ( 0 , 0 , 0 );

				pCrab = CBaseEntity::Create( "monster_target",vecSpot, vecSpot, edict() ); // create the crab

				pCrab->pev->health = 1;
			}
			ALERT(at_console, "pObject->g_bBrekeableObject == TRUE\n" );
		}		
		ALERT(at_console, "pObject\n" );
	}
*/
	/*
	...
	if (!pEntity)
	{
//		ALERT(at_error, "can't find env_fog!, anyways iDistToShoot is: %i\n", iDistToShoot);

		iDistToShoot = HUMAN_RIFLE_RANGE;//normal shoot
	}
	else
	{
//		ALERT(at_error, "ops, i can't see so much 'cause env_fog is present, iDistToShoot is: %i\n", iDistToShoot);

		iDistToShoot = HUMAN_RIFLE_RANGE/2;//modified range
	}
*/
	if(m_bKamikaze)
	{
...
/*
		...
		{
			ExplosionCreate( vecHand, pev->angles, edict(), 100, TRUE );
			GibMonster();
...
*/
		//m_iFrustration = 0;//dont get frustrated //not necesary
...
/*
	if (IsTalking())
	{
		...
		pSprite->pev->origin.y += 90;
	}
	else
	{
		pSprite->SetTransparency( kRenderTransAdd, 0, 0, 0, 255, kRenderFxNone );
		pSprite->SetScale( 0.3 );
		pSprite->SetAttachment( edict(), 0 );
		pSprite->pev->frame = 0;
		pSprite->pev->framerate = 0;
...
//*********** LOD
	...
	if(!bTerrorist)
	{
		...
		{	
			...
			if ( IsAlive() && pev->deadflag != DEAD_DYING )
			{
				if ( flDist >= 600 || (pev->weapons == HUMAN_WEAPON_NONE) /*|| !m_fGunDrawn*/ )
				{
					REMOVE_P_MODEL;
				}
				else
				{
				//	if( pev->weapons != HUMAN_WEAPON_NONE )//we have a weapon
					SET_P_MODEL;
				}
			}
...
*/
	...
	case MONSTERSTATE_COMBAT:
		...
		/*	CBaseEntity *pEntidadLODcheck1 = NULL;
			...
			if ( bTerrorist && (!m_bSurrender) && (m_iFrustration >= m_iBreakPoint) && (!m_bKamikaze) && (!m_bDontReact) )
			{
		...
		//	return GetScheduleOfType( SCHED_HUMAN_FIREUP );
			...
			//	++m_iFrustration;
				...
				{//if terrorist is not surrender and not kamikaze and random value
					...
					if ( bTerrorist && (!m_bSurrender) && (!m_bKamikaze) && (RANDOM_LONG(0,99) < 40) )
					{		
...
/*
		switch (m_iPosition)
		{
			case NEAR_DOOR: ClientPrint(pPlayer->pev, HUD_PRINTTALK, "AG Member(RADIO): Suspect near Door" ); break;
			case NEAR_LADDER: ClientPrint(pPlayer->pev, HUD_PRINTTALK, "AG Member(RADIO): Suspect near Ladder" ); break;
			case NEAR_BREKABLE: ClientPrint(pPlayer->pev, HUD_PRINTTALK, "AG Member(RADIO): Suspect near Boxes" ); break;
			case NEAR_TRAIN: ClientPrint(pPlayer->pev, HUD_PRINTTALK, "AG Member(RADIO): Suspect near Train" ); break;
			case NEAR_PLAT: ClientPrint(pPlayer->pev, HUD_PRINTTALK, "AG Member(RADIO): Suspect near Plat" ); break;
			case NEAR_GLASS_BREKABLE: ClientPrint(pPlayer->pev, HUD_PRINTTALK, "AG Member(RADIO): Suspect near Glass" ); break;
		}
*/
		if (m_hEnemy->m_iPosition == NEAR_DOOR)
		{
//			PlaySentence( "FG_DOOR", 2, VOL_NORM, ATTN_IDLE );
			ClientPrint(pPlayer->pev, HUD_PRINTTALK, "AG Member(RADIO): Suspect near Door" );
		}

		if (m_hEnemy->m_iPosition == NEAR_LADDER)
		{
//			PlaySentence( "FG_LADDER", 2, VOL_NORM, ATTN_IDLE );
			ClientPrint(pPlayer->pev, HUD_PRINTTALK, "AG Member(RADIO): Suspect near Ladder" );
		}

		if (m_hEnemy->m_iPosition == NEAR_BREKABLE)
		{
//			PlaySentence( "FG_BREKABLE", 2, VOL_NORM, ATTN_IDLE );
			ClientPrint(pPlayer->pev, HUD_PRINTTALK, "AG Member(RADIO): Suspect near Boxes" );
		}

		if (m_hEnemy->m_iPosition == NEAR_TRAIN)
		{
//			PlaySentence( "FG_TRAIN", 2, VOL_NORM, ATTN_IDLE );
			ClientPrint(pPlayer->pev, HUD_PRINTTALK, "AG Member(RADIO): Suspect near Train" );
		}

		if (m_hEnemy->m_iPosition == NEAR_PLAT)
		{
//			PlaySentence( "FG_PLAT", 2, VOL_NORM, ATTN_IDLE );
			ClientPrint(pPlayer->pev, HUD_PRINTTALK, "AG Member(RADIO): Suspect near Plat" );
		}

		if (m_hEnemy->m_iPosition == NEAR_GLASS_BREKABLE)
		{
//			PlaySentence( "FG_GLASS_BREKABLE", 2, VOL_NORM, ATTN_IDLE );
			ClientPrint(pPlayer->pev, HUD_PRINTTALK, "AG Member(RADIO): Suspect near Glass" );
		}
	}
...
/*
CBaseEntity* CBaseHuman :: DropItem( char *pszItemName, const Vector &vecPos, const Vector &vecAng )
{
	if ( !pszItemName )
	{
	...
	if ( pItem )
	{
		...
		pItem->pev->velocity =  Vector ( 0,0,0 );
		pItem->pev->avelocity = Vector ( 0,0,0 );
				
		pItem->pev->armorvalue = m_cAmmoLoaded;//new

		edict_t *pFind; 
		pFind = FIND_ENTITY_BY_CLASSNAME( NULL, "game_theme" );

		if (!FNullEnt( pFind ))
		{
			CBaseEntity *pEnt = CBaseEntity::Instance( pFind );
			CThemeSettings *pThemeSettings = (CThemeSettings *)pEnt;

		//	pItem->sz_model_theme = (char *)STRING(pThemeSettings->szTheme);
		}
