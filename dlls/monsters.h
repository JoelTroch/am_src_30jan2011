...
#define GIB_HUMAN			1
#define GIB_PALM			2
#define GIB_ALIEN_STICKY	3
#define GIB_HUMAN_STICKY	4
#define GIB_HGRUNT			5
#define GIB_MIKEFORCE		6
#define GIB_HGRUNTMEDIC		7
#define GIB_ARMYMEDIC		8
#define GIB_SOG				9
#define GIB_CHARLIE_NVA_BROWN	10
#define GIB_CHARLIE_NVA_GREEN	11
#define GIB_CHARLIE_VC			12
#define GIB_CHARLIE_VC2			13

#define GERMAN_GIB_COUNT		4
#define ALIEN_GIB_COUNT			4
#define PALM_GIB_COUNT			7
#define STICKY_GIB_COUNT		3
#define HGRUNT_GIB_COUNT		8
#define MIKEFORCE_GIB_COUNT		8
#define HGRUNTMEDIC_GIB_COUNT	8
#define ARMYMEDIC_GIB_COUNT		8
#define SOG_GIB_COUNT			8
#define CHARLIE_GIB_COUNT		7
