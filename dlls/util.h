...
extern void			UTIL_ParticleEmiterPreset( const Vector &vecOrigin, const unsigned &iPreset );
extern void			UTIL_ParticleEmiterFromFile( const Vector &vecOrigin, const char * file );
...
extern void UTIL_CustomDecal( TraceResult *pTrace, const char *name, int persistent );
...
extern BOOL			UTIL_IsTextureSky( TraceResult *tr, Vector vecSrc, Vector vecEnd );
...
//SYS: Database related
extern void	DBSetExperiencePoints( int iValue );
extern int	DBGetExperiencePoints();
extern void DBInit();
extern void DBCheckIntegrity();
extern void DBSetPageUnlocked();
extern int DBGetPageUnlocked();
extern void DBGet();
extern int	DBGetFinalCode();
extern void DBSetKills( int iValue );
extern void DBSetHeadshots( int iValue );
extern void DBSetMelees( int iValue );
