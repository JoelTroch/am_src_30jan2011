...
//	int TakeDamage( entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage, int bitsDamageType);
	...
	BOOL m_bIsSfera;
	BOOL m_bIsANormalExplosionNotGas;
...
#define WEAPON_CROWBAR			1//normal knife
#define	WEAPON_GLOCK			2//1911!!!
#define WEAPON_PYTHON			3//357
#define WEAPON_MP5				4
#define WEAPON_SHOTGUN			5
#define WEAPON_RPG				6
#define WEAPON_HANDGRENADE		7
#define WEAPON_FLASHLIGHT		8
#define	WEAPON_C4				9
#define WEAPON_FINAL			10
#define	WEAPON_M16				12
#define	WEAPON_AK74				13
#define	WEAPON_DEAGLE			14
#define	WEAPON_SNIPER			15
#define	WEAPON_FAMAS			16
#define WEAPON_USAS				17
#define WEAPON_M249				18
#define WEAPON_UZI				19
#define WEAPON_BER92F			20
#define WEAPON_GLOCK18			21
#define WEAPON_M4A2				22
#define WEAPON_OICW				23//this could be removed
#define WEAPON_PDA				24
#define WEAPON_SVD				25  //since it's not used, I'll pick this index for the svd
#define WEAPON_EPIPEN			26 //syringe gun
#define WEAPON_SKORPION			27
#define WEAPON_FISTS			28

#define WEAPON_SHOTGUN_LESSLETHAL	29

#define WEAPON_HEAL				30 //syringe gun
#define WEAPON_SUIT				31	// ?????

#define WEAPON_ALLWEAPONS		(~(1<<WEAPON_SUIT))
#define MAX_WEAPONS			82
#define MAX_CARRIAGE		6//what a nice word <<
...
#define HANDGRENADE_DEFAULT_GIVE	1 //5?? Pero si es solo una!
...
typedef	enum
{
	...
	BULLET_PLAYER_P90,
	BULLET_PLAYER_M82,
	BULLET_PLAYER_RUBBER,
	BULLET_PLAYER_EXPLOSIVE,
...
#define FIREMODE_FULL		0
#define FIREMODE_SEMI		1
#define FIREMODE_BURST		2
//#define FIREMODE_SAFE		3//useless

#define SILENCER_OFF_FULLAUTO	0
#define SILENCER_ON_FULLAUTO	1
#define SILENCER_OFF_SEMI		2
#define SILENCER_ON_SEMI		3

struct oWepModifiers
{
	int iScope;
	int iSilencer;
	int iRedDot;
...
//	virtual void UpdateItemInfo( void ) {};	// updates HUD state
	...
	float	m_flNextFourthAttack;
/*
	float ROF( float rate_of_fire )
	{
		ALERT(at_console, "flCycleTime %f\n", 1.0/rate_of_fire*60.0);
		return 1.0/rate_of_fire*60.0;
	};
*/
#if NO_COMPILE_HOE
	virtual void FindHullIntersection( const Vector &vecSrc, TraceResult &tr, float *mins, float *maxs, edict_t *pEntity );
#endif
...
#define LOUD_GUN_VOLUME			2000
#define NORMAL_GUN_VOLUME		1000
#define QUIET_GUN_VOLUME		500
...
public:
	...
	void MP5Fire( float flSpread, float flCycleTime, BOOL fUseAutoAim, BOOL Silenced );
    void MP5FireSilenced( float flSpread, float flCycleTime, BOOL fUseAutoAim, BOOL Silenced );
...
private:
	unsigned short m_usFireMP51;
	unsigned short m_usFireMP52;
};
...
class CShotgunLessLethal : public CBasePlayerWeapon
{
public:
/*
#ifndef CLIENT_DLL
...
// NEW CM16 CLASS (ammo class stored in cpp file)
...
public:
	...
	void M16Fire( float flSpread, float flCycleTime, BOOL fUseAutoAim, BOOL Silenced );
    void M16FireSilenced( float flSpread, float flCycleTime, BOOL fUseAutoAim, BOOL Silenced );
...
private:
	unsigned short m_usFireM161;
	unsigned short m_usFireM162;
};
#endif
// NEW AK74 CLASS (ammo class stored in cpp file)
...
private:
    unsigned short m_usAK74;
	unsigned short m_usAk_stab;
};

// CLASE DEAGLE | ARMA MUNICION
...
//	BOOL b_Deagle1Sending;
//	BOOL b_Deagle2Sending;
	void KeyValue( KeyValueData *pkvd );
...
class CSkorpion : public CBasePlayerWeapon
{
public:
	void Spawn( void );
	void Precache( void );
...
private:
	unsigned short m_usFireSvd;
};

class CSvdAmmoClip : public CBasePlayerAmmo
{
    virtual void Spawn( void );    
	virtual void Precache( void );
    virtual BOOL AddAmmo( CBaseEntity *pOther ) ;
...
/*
class CFaknife : public CBasePlayerWeapon
{
public:
	void Spawn( void );
	void Precache( void );
...
private:
	unsigned short m_usFaknife;
	unsigned short m_usFaknife_stab;
};
*/
...
private:
	unsigned short m_usFireUsas;
	unsigned short m_usSpriteTracer;
};


class CLX : public CBasePlayerWeapon
{
public:
...
//#endif
	...
	int m_iGlow;
	int m_iBeam;
	int m_iFireEff; // don't save this |SP: hacé lo que quieras---
	int m_iSoundState; // don't save this
...
private:
	unsigned short m_usLxFire;
	unsigned short m_usLxSpin;
};
...
// NEW heal  CLASS (ammo class stored in cpp file)
class CEpipen : public CBasePlayerWeapon
{
public:
	void Spawn( void );
	void Precache( void );
...
// NEW heal  CLASS (ammo class stored in cpp file)
class CPDA : public CBasePlayerWeapon
{
public:
	void Spawn( void );
	void Precache( void );
