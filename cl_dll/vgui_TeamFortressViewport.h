...
/////////
	...
	int MsgFunc_Keypad( const char *pszName, int iSize, void *pbuf );
	int MsgFunc_OS( const char *pszName, int iSize, void *pbuf );
	//BP ParticleEmitter
...
class CHealthPanel : public Panel
{

private:

	CImageLabel	*m_pHealthLabel;
	CImageLabel	*m_pBarHealthLabel;
	CImageLabel	*m_pBarArmorLabel;
...
private:
	...
	CImageLabel	*m_pSlotPreWpLabel	[ MAX_WEAPON_POSITIONS ];
	CImageLabel	*m_pSlotWeaponLabel	[ MAX_WEAPON_SLOTS ][ MAX_WEAPON_POSITIONS ];
	CImageLabel	*m_pSlotSelWeaponLabel	[ MAX_WEAPON_SLOTS ][ MAX_WEAPON_POSITIONS ];
