...
//#define RGB_GREENISH 0x0000A000 //0,160,0 What the... !
...
#define HUD_COLOR			CVAR_GET_FLOAT("hud_red"), CVAR_GET_FLOAT("hud_green"), CVAR_GET_FLOAT("hud_blue")
#define HUD_COLOR_PRESSED	CVAR_GET_FLOAT("hud_red") /2, CVAR_GET_FLOAT("hud_green") /2, CVAR_GET_FLOAT("hud_blue") /2
...
public:
	...
	void LoadMenuSettings( void );// buz
...
class CHudNoise: public CHudBase
{
public:
int Init( void );
int VidInit( void );
...
public:
	...
	CShinySurface( float fScale, float fAlpha, float vAbsMax_x, float vAbsMax_y, float vAbsMax_z, float vAbsMin_x, float vAbsMin_y, float vAbsMin_z, char *szSprite);
	~CShinySurface();
...
//	~CHud();			// destructor, frees allocated memory
	...
	int _cdecl MsgFunc_SlowMotion(const char *pszName, int iSize, void *pbuf );
