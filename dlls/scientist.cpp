...
LINK_ENTITY_TO_CLASS( monster_hostage, CScientist );
...
//	m_flDistTooFar		= 256.0;
	...
	if ( FClassnameIs(pev, "monster_hostage"))
	{
		switch (RANDOM_LONG(1,6))
		{
			...
			case 4: pev->skin = 4; break;
			case 5: pev->skin = 5; break;
			case 6: pev->skin = 6; break;
		}
	}
