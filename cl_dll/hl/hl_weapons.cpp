...
CMP5 g_Mp5;
CShotgun g_Shotgun;
CShotgunLessLethal g_ShotgunLessLethal;
CRpg g_Rpg;
//CHgun g_HGun;
...
void HUD_InitClientWeapons( void )
{
	...
	HUD_PrepEntity( &g_ShotgunLessLethal	, &player );
...
//	HUD_PrepEntity( &g_Hand			, &player );
	...
	HUD_PrepEntity( &g_Skorpion			, &player );
	
	HUD_PrepEntity( &g_UZI			, &player );
	HUD_PrepEntity( &g_Ber92f		, &player );
	HUD_PrepEntity( &g_Glock18		, &player );
	HUD_PrepEntity( &g_Usas			, &player );
	HUD_PrepEntity( &g_Svd			, &player );

	HUD_PrepEntity( &g_Oicw			, &player );	

//	HUD_PrepEntity( &g_Crossbow	, &player );

	HUD_PrepEntity( &g_M4A2		, &player );
	HUD_PrepEntity( &g_Heal				, &player );
	HUD_PrepEntity( &g_Pda				, &player );
	HUD_PrepEntity( &g_Epipen				, &player );
...
//			break;
		...
		case WEAPON_HL2_USP:
		 ...
		 case WEAPON_HL2_IRGUN:
		  pWeapon = &g_IRGUN;
			  break;

		 case WEAPON_HL2_SHOTGUN:
		  pWeapon = &g_HL2Shotgun;
		  break;

//		case WEAPON_HL2_CROWBAR:
//		  pWeapon = &g_HL2Crowbar;
//		  break;

		case WEAPON_HL2_HANDGRENADE:
		...
		case WEAPON_FAMAS:        
			pWeapon = &g_Famas;        
			break;
//SP: UNDONE: despues agregar de nuevo esto			
		case WEAPON_PYTHON:
			pWeapon = &g_Python;
			break;
...
//			 body = 1;
	...
	/*	
		...
		body = 	view->curstate.body;//FIXES PROBLEM WITH ANIMS
*/
