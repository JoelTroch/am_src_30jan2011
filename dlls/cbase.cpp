...
void DispatchSave( edict_t *pent, SAVERESTOREDATA *pSaveData )
{
	...
	if ( pEntity && pSaveData )
	{
		...
		pTable->classname = pEntity->pev->classname;	// Remember entity class for renorm
...
{
	//apply sky entity
   //       if(pev->spawnflags & 2048)SetBits( pev->flags, FL_SKYENTITY );

	//rebuild all parents
//	UTIL_RebuildList(this);
//	if(m_physinit && !NewLevel)return;
