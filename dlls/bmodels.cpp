...
public:
	...
	void	Precache( void ) {};//so it can be access from func_collision
...
/*
		...
		WRITE_COORD(pev->absmin.z + 2);*/
			...
			WRITE_COORD(pev->absmax.x-1.99);
			WRITE_COORD(pev->absmax.y-1.99);
			WRITE_COORD(pev->absmax.z-1.99);
			WRITE_COORD(pev->absmin.x+1.99);
			WRITE_COORD(pev->absmin.y+1.99);
			WRITE_COORD(pev->absmin.z+1.99);
