...
//		UTIL_ShowMessageAll( STRING(pev->message) );	//strings code
	//	UTIL_ShowMessage( STRING(pev->message), pPlayer );	//strings code

//		UTIL_ShowMessagePVS( STRING(pev->message), pActivator->pev->origin ); // buz
	}
...
/*
	...
	default://don't send sounds
	case CHAR_TEX_CONCRETE: fvol = 0.9;	fvolbar = 0.6;
		rgsz[0] = "weapons/bulletimpact/concrete1.wav";
		rgsz[1] = "weapons/bulletimpact/concrete2.wav";
		rgsz[2] = "weapons/bulletimpact/concrete3.wav";
		cnt = 3;
		break;
	case CHAR_TEX_METAL: fvol = 0.9; fvolbar = 0.3;
		rgsz[0] = "weapons/bulletimpact/metal1.wav";
		rgsz[1] = "weapons/bulletimpact/metal2.wav";
		rgsz[2] = "weapons/bulletimpact/metal3.wav";
		cnt = 3;
		break;
	case CHAR_TEX_DIRT:	fvol = 0.9; fvolbar = 0.1;
	...
	case CHAR_TEX_SLOSH: fvol = 0.9; fvolbar = 0.0;
		...
		break;
	case CHAR_TEX_WOOD: fvol = 0.9; fvolbar = 0.2;
		rgsz[0] = "weapons/bulletimpact/wood1.wav";
		rgsz[1] = "weapons/bulletimpact/wood2.wav";
		rgsz[2] = "weapons/bulletimpact/wood3.wav";
		cnt = 3;
		break;
	case CHAR_TEX_GLASS:
	case CHAR_TEX_COMPUTER:
	...
	else
	{
		if ( RANDOM_LONG( 0, 1 ) == 0 )
		{
			...
			*/
				case 0:UTIL_EmitAmbientSound(ENT(0), ptr->vecEndPos, "weapons/ric1.wav", 1.5, fattn, 0, 96 + RANDOM_LONG(0,0xf));break;
				case 1:UTIL_EmitAmbientSound(ENT(0), ptr->vecEndPos, "weapons/ric2.wav", 1.5, fattn, 0, 96 + RANDOM_LONG(0,0xf));break;
				case 2:UTIL_EmitAmbientSound(ENT(0), ptr->vecEndPos, "weapons/ric3.wav", 1.5, fattn, 0, 96 + RANDOM_LONG(0,0xf));break;
				case 3:UTIL_EmitAmbientSound(ENT(0), ptr->vecEndPos, "weapons/ric4.wav", 1.5, fattn, 0, 96 + RANDOM_LONG(0,0xf));break;
				case 4:UTIL_EmitAmbientSound(ENT(0), ptr->vecEndPos, "weapons/ric5.wav", 1.5, fattn, 0, 96 + RANDOM_LONG(0,0xf));break;
			}
		}
	}
...
/*
TYPEDESCRIPTION	CGrassSprite::m_SaveData[] = 
{
	DEFINE_FIELD( CGrassSprite, m_fRadius, FIELD_FLOAT ),
	DEFINE_FIELD( CGrassSprite, m_iDensity, FIELD_INTEGER ),
	DEFINE_FIELD( CGrassSprite, m_fScale, FIELD_INTEGER ),
	DEFINE_FIELD( CGrassSprite, m_iMode, FIELD_INTEGER ),
	DEFINE_FIELD( CGrassSprite, m_iNumTextures, FIELD_INTEGER ),
	DEFINE_ARRAY( CGrassSprite, m_strTextures, FIELD_STRING, MAX_TYPE_TEXTURES ),
};

IMPLEMENT_SAVERESTORE( CGrassSprite, CPointEntity );*/
