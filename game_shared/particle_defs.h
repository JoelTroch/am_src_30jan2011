...
//muzzleflashes
const unsigned int MUZZ_GENERIC = 0;

const unsigned int MUZZ_AK = 1;
const unsigned int MUZZ_DEAGLE = 2;
const unsigned int MUZZ_M16 = 3;
const unsigned int MUZZ_M4A1 = 4;
const unsigned int MUZZ_M249 = 5;
...
//muzzleflashes
/*
const char MUZZ_PARTICLE_GEN[MAX_PARTICLE_PATH] = "particles/engine/muzzle_gen.tga";

const char MUZZ_PARTICLE_AK[MAX_PARTICLE_PATH] = "particles/engine/muzzle_ak47.tga";
const char MUZZ_PARTICLE_DEAGLE[MAX_PARTICLE_PATH] = "particles/engine/muzzle_deagle.tga";
const char MUZZ_PARTICLE_M16[MAX_PARTICLE_PATH] = "particles/engine/muzzle_m16.tga";
const char MUZZ_PARTICLE_M4A1[MAX_PARTICLE_PATH] = "particles/engine/muzzle_m4a1.tga";
const char MUZZ_PARTICLE_M249[MAX_PARTICLE_PATH] = "particles/engine/muzzle_m249.tga";
*/
//new add

const char blood_human[MAX_PARTICLE_PATH] = "particles/engine/blood_human.tga";
const char blood_human_core[MAX_PARTICLE_PATH] = "particles/engine/blood_human_core.tga";
const char bloodpit_red[MAX_PARTICLE_PATH] = "particles/engine/bloodpit_red.tga";

//used by crete shot
const char fleck_cement1[MAX_PARTICLE_PATH] = "particles/engine/fleck_cement1.tga";
const char particle_grey[MAX_PARTICLE_PATH] = "particles/engine/particle_grey.tga";
const char debris_crete[MAX_PARTICLE_PATH] = "particles/engine/debris_crete.tga";

const char fleck_wood1[MAX_PARTICLE_PATH] = "particles/engine/fleck_wood1.tga";
const char particle_brown[MAX_PARTICLE_PATH] = "particles/engine/particle_brown.tga";

const char water_drop[MAX_PARTICLE_PATH] = "particles/engine/water_drop.tga";
const char water_ripples01[MAX_PARTICLE_PATH] = "particles/engine/water_ripples01.tga";
const char water_splash[MAX_PARTICLE_PATH] = "particles/engine/water_splash.tga";

const char sparks01[MAX_PARTICLE_PATH] = "particles/engine/sparks01.tga";
const char particle_blood_splat01[MAX_PARTICLE_PATH] = "particles/engine/particle_blood_splat01.tga";
const char particle_blood_splat02[MAX_PARTICLE_PATH] = "particles/engine/particle_blood_splat02.tga";
const char glass[MAX_PARTICLE_PATH] = "particles/engine/glass.tga";

//used by explosions
const char exp1[MAX_PARTICLE_PATH] = "particles/exp1.tga";
const char exp_glow[MAX_PARTICLE_PATH] = "particles/exp_glow.tga";
const char smoke01[MAX_PARTICLE_PATH] = "particles/smoke01.tga";
...
const char chunk[MAX_PARTICLE_PATH] = "particles/chunk.tga";
const char dirt01[MAX_PARTICLE_PATH] = "particles/dirt01.tga";
...
const unsigned int iDefaultSlowMoEffect = 35;//slomo waves
const unsigned int iDefaultLeaves = 36;//leaves
const unsigned int iDefaultLeavesBush = 37;//bush leaves
const unsigned int iBloodSplat = 38;//bloodsplat (red)
const unsigned int iSoulAttack = 39;//
const unsigned int iSoulFly = 40;//
const unsigned int iSoulDie = 41;
const unsigned int iDefaultHitSparks = 42;//sparks

const unsigned int iDefaultBloodSlowCore = 43;
const unsigned int iDefaultBloodSlowDrop = 44;
const unsigned int iDefaultGlass = 45;//glass
const unsigned int iDefaultExplosionGrass = 46;
const unsigned int iDefaultSmokeRPG = 47;
const unsigned int iDefaultExplosionGas = 48;
const unsigned int iDefaultFireSpark = 49;
const unsigned int DEBUG_DOT = 50;
const unsigned int DEBUG_DOT_RED = 51;
