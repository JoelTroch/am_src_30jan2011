...
//		ALERT ( at_console, "I touch something!  %f\n", tr.flFraction );
		...
		{
			//DUAAAAAAAASDO ASDKAJSdlashdkl jashdlkajsdhkasjdhasmdas.d, a.s,d .asd JO jejejejejejej ehe he....
/*
			MESSAGE_BEGIN(MSG_ALL, gmsgParticles);
				WRITE_SHORT(0);
				WRITE_BYTE(0);
...
void CApacheHVR :: Spawn( void )
{
	...
	SET_MODEL(ENT(pev), "models/rpgrocket.mdl");//precached by wep_rpg, always precached
