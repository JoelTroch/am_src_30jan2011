...
// $NoKeywords: $
//=============================================================================
#define MAXSTUDIOLIGHTS 512

#define STUDIOPROJECTION 2048
...
public:
	...
	// Estimate gait frame for ents
	virtual void StudioEstimateGaitForEnt ( cl_entity_s *pEnt );

	// Process movement of ents
	virtual void StudioProcessGaitForEnt ( cl_entity_s *pEnt );
