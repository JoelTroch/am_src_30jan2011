...
void TabPanelInit()
{
	...
	hidetime = gEngfuncs.pfnRegisterVariable( "gpanel_hidetime", "9999", 0 );//20 stays forever?
}
...
//	m_pTitle->setFgColor(248, 164, 6, 0);
	m_pTitle->setFgColor(HUD_COLOR, 0);
	m_pBkPanel->setBgColor(HUD_COLOR_PRESSED, 50);
