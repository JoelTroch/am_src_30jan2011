...
DLL_DECALLIST gDecals[] = {
	...
	{ "{bigblood1", 0 },	// DECAL_BIGBLOOD1
	{ "{bigblood2", 0 },	// DECAL_BIGBLOOD2
	{ "{ybigblood1", 0 },	// DECAL_YBIGBLOOD1
	{ "{ybigblood2", 0 },	// DECAL_YBIGBLOOD2
	{ "{blackspit1", 0 },	// DECAL_BLACKSPIT1
	{ "{blackspit2", 0 },	// DECAL_BLACKSPIT2
	{ "{tire2", 0 },//	DECAL_TIRE, 
};
...
//#include "../newton/common/RenderPrimitive.h"
...
*/
	//we don't need anymore those stupids sounds
	/*
...
//	PRECACHE_SOUND( "player/radar_warning.wav" );

//	PRECACHE_SOUND( "player/damage/suicide.wav" );//kinda unuseful

	PRECACHE_SOUND( "player/damage/hit_flesh-1.wav" );
	PRECACHE_SOUND( "player/damage/hit_flesh-2.wav" ); // si le pega en la carne

	//let's use less sounds. by default bullet_hit1 is played when a bullet impact a flesh
	//m_hit1 is don't needed at all.


			PRECACHE_MODEL (	"sprites/rope.spr");

/*
	PRECACHE_MODEL ("sprites/lens/lens21.spr");
	PRECACHE_MODEL ("sprites/lens/lens7.spr");
	PRECACHE_MODEL ("sprites/lens/glow01.spr");
	PRECACHE_MODEL ("sprites/lens/glow1.spr");
	PRECACHE_MODEL ("sprites/lens/glow.spr");
	PRECACHE_MODEL ("sprites/lens/lens11.spr");
	PRECACHE_MODEL ("sprites/lens/lensflare1.spr");
	PRECACHE_MODEL ("sprites/lens/lensglare1.spr");*/

//	PRECACHE_MODEL ("sprites/llamas.spr");

	
	//using particle's system now
...
//	PRECACHE_SOUND( "weapons/bullet.wav" );
	...
	/*
	PRECACHE_SOUND( "weapons/explosions/explode1.wav" );
	PRECACHE_SOUND( "weapons/explosions/explode2.wav" );
	PRECACHE_SOUND( "weapons/explosions/explode3.wav" );
	PRECACHE_SOUND( "weapons/explosions/explode4.wav" );
	PRECACHE_SOUND( "weapons/explosions/explode5.wav" );

	PRECACHE_SOUND( "weapons/explosions/explode_dist1.wav" );
	PRECACHE_SOUND( "weapons/explosions/explode_dist2.wav" );
	PRECACHE_SOUND( "weapons/explosions/explode_dist3.wav" );

	PRECACHE_SOUND( "weapons/explosions/underwater_explode3.wav" );
	PRECACHE_SOUND( "weapons/explosions/underwater_explode4.wav" );
*/
	...
	//dont are used fow now
//	PRECACHE_MODEL( "models/stickygib.mdl" );//test
//	PRECACHE_MODEL( "sprites/bloodfrag2.spr" );//test
